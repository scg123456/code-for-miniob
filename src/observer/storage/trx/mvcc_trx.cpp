...
RC MvccTrxKit::init()
{
  ...
  fields_ = vector<FieldMeta>{
      ...
      FieldMeta("__trx_xid_begin", AttrType::INTS, 0 /*attr_offset*/, 4 /*attr_len*/, false /*visible*/, false, -1/*field_id*/),
      FieldMeta("__trx_xid_end", AttrType::INTS, 0 /*attr_offset*/, 4 /*attr_len*/, false /*visible*/, false, -2/*field_id*/)};
